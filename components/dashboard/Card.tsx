      ...
      {isLoading ? (
        <>
          <div className="flex items-start justify-between">
            <div className="w-10 h-10 bg-slate-200 rounded-md animate-pulse-fast" />
            <div className="w-7 h-6 bg-slate-200 rounded-md animate-pulse-fast" />
          </div>
          <div className="space-y-2">
            <div className="w-17 h-3 bg-slate-200 rounded-md animate-pulse-fast" />
            <div className="w-27 h-3 bg-slate-200 rounded-md animate-pulse-fast" />
          </div>
        </>
      ) : (
        <>
          ...
          <div>
            ...
            <p className="md:block text-[9px] text-gray-400 lg:text-xs">
              {desc}
            </p>
          </div>
        </>
